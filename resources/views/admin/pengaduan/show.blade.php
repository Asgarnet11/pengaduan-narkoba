...
<div class="max-w-4xl mx-auto py-10">
    <div class="bg-white shadow rounded-lg p-6">
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex items-center space-x-4">
                <form action="{{ route('admin.pengaduan.update-status', $pengaduan->id) }}" method="POST" class="flex items-center">
                    @csrf
                    @method('PUT')
                    ...
                    <button type="submit" class="ml-2 px-3 py-1 bg-indigo-600 text-white text-sm rounded hover:bg-indigo-700">Update Status</button>
                </form>
            </div>
        </div>
    ...
    <div class="mt-6">
        <a href="{{ route('admin.dashboard') }}" class="inline-block px-4 py-2 bg-gray-200 text-gray-700 rounded hover:bg-gray-300 transition">Kembali ke Dashboard</a>
    </div>
</div>
@endsection
