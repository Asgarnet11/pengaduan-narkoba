...
@section('title', 'Selamat Datang - Sistem Pengaduan Masyarakat')

@section('content')
<div class="relative">
    <!-- Hero Section -->
    <div class="relative bg-gradient-to-br from-indigo-600 to-blue-500 overflow-hidden">
        <!-- Animated Background -->
        <div class="absolute inset-0" id="animated-bg"></div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="text-center lg:text-left" data-aos="fade-right">
                    <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 animate__animated animate__fadeInUp">
                        Suara Anda Penting <br>untuk Perubahan
                    </h1>
                    <p class="text-lg md:text-xl text-indigo-100 mb-8 animate__animated animate__fadeInUp animate__delay-1s">
                        Platform pengaduan masyarakat yang memudahkan komunikasi antara warga dan perangkat desa untuk pelayanan yang lebih baik.
                    </p>
                    <div class="space-x-4 animate__animated animate__fadeInUp animate__delay-2s">
                        @auth
                            <a href="{{ route('dashboard') }}" class="btn-primary inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-lg text-indigo-600 bg-white hover:bg-indigo-50 transform hover:scale-105 transition-all duration-300">
                                <i class="fas fa-tachometer-alt mr-2"></i>
                                Dashboard
                            </a>
                        @else
                            <a href="{{ route('login') }}" class="btn-primary inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-lg text-indigo-600 bg-white hover:bg-indigo-50 transform hover:scale-105 transition-all duration-300">
                                <i class="fas fa-sign-in-alt mr-2"></i>
                                Masuk
                            </a>
                            <a href="{{ route('register') }}" class="btn-primary inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-lg text-white bg-indigo-800 bg-opacity-50 hover:bg-opacity-70 transform hover:scale-105 transition-all duration-300">
                ...
                <div class="hidden lg:block" data-aos="fade-left">
                    <img src="https://illustrations.popsy.co/white/work-from-home.svg" alt="Hero Illustration" class="w-full max-w-lg mx-auto transform hover:scale-105 transition-transform duration-500 animate__animated animate__fadeInRight">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16" data-aos="fade-up">
                ...
                <p class="text-lg text-gray-600 max-w-2xl mx-auto">Beberapa fitur yang memudahkan Anda dalam menyampaikan pengaduan dan memantau progresnya.</p>
            </div>
    ...
    <div class="relative bg-indigo-700 py-20">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center" data-aos="zoom-in">
            ...
            <div class="inline-flex rounded-md shadow">
                @auth
                    <a href="{{ route('pengaduan.create') }}" class="btn-primary inline-flex items-center justify-center px-8 py-4 border border-transparent text-base font-medium rounded-lg text-indigo-600 bg-white hover:bg-indigo-50 transform hover:scale-105 transition-all duration-300">
                        <i class="fas fa-plus-circle mr-2"></i>
                        Buat Pengaduan
                    </a>
                @else
                    <a href="{{ route('register') }}" class="btn-primary inline-flex items-center justify-center px-8 py-4 border border-transparent text-base font-medium rounded-lg text-indigo-600 bg-white hover:bg-indigo-50 transform hover:scale-105 transition-all duration-300">
                        <i class="fas fa-user-plus mr-2"></i>
                        Daftar Sekarang
                    </a>
                @endauth
