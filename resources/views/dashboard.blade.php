...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <!-- Welcome Section -->
        <div class="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-2xl shadow-xl overflow-hidden mb-8" data-aos="fade-up">
                ...
                <div class="relative">
                    <div class="flex items-center justify-between">
                        <div class="animate__animated animate__fadeInLeft">
                            ...
                            <p class="text-indigo-100">Selamat datang di Dashboard Pengaduan Masyarakat</p>
                        </div>
                        <div class="hidden md:block animate__animated animate__fadeInRight">
                            <img src="https://illustrations.popsy.co/white/resistance-band.svg" alt="Dashboard Hero" class="w-48">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <!-- Total Pengaduan -->
            <div class="hover-card bg-white rounded-xl p-6 shadow-lg transition-all duration-300" data-aos="fade-up" data-aos-delay="100">
            ...
            <!-- Pengaduan Diproses -->
            <div class="hover-card bg-white rounded-xl p-6 shadow-lg transition-all duration-300" data-aos="fade-up" data-aos-delay="200">
                <div class="flex items-center">
            ...
            <!-- Pengaduan Selesai -->
            <div class="hover-card bg-white rounded-xl p-6 shadow-lg transition-all duration-300" data-aos="fade-up" data-aos-delay="300">
                <div class="flex items-center">
            ...
            <!-- Pengaduan Ditolak -->
            <div class="hover-card bg-white rounded-xl p-6 shadow-lg transition-all duration-300" data-aos="fade-up" data-aos-delay="400">
                <div class="flex items-center">
        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden" data-aos="fade-up" data-aos-delay="500">
            <div class="p-6 border-b border-gray-200">
                <div class="flex justify-between items-center">
                    ...
                    <a href="{{ route('pengaduan.create') }}" class="btn-primary inline-flex items-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-lg transition-all duration-300 transform hover:scale-105">
            ...
            <div class="divide-y divide-gray-200">
                ...
                @empty
                    <div class="p-12 text-center" data-aos="fade-up">
                        <img src="https://illustrations.popsy.co/gray/falling-box.svg" alt="No Data" class="w-48 mx-auto mb-6">
            ...
            @if($recentPengaduan->count() > 0)
                <div class="p-6 bg-gray-50 border-t border-gray-200">
                    <a href="{{ route('pengaduan.index') }}" class="text-sm font-medium text-indigo-600 hover:text-indigo-700 transition-colors duration-200">
